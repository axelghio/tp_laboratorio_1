...
int ll_set(LinkedList* this, int index,void* pElement)
{
    ...
    if(this != NULL && index >= 0 && index < ll_len(this))
    {
        auxpElement = getNode(this, index);
        auxpElement->pElement = pElement;
        returnAux = 0;
    }
    return returnAux;
}
...
int ll_remove(LinkedList* this,int index)
{
    ...
    if(this != NULL && index >= 0 && index < ll_len(this))
    {
        ...
        if(thisNode != NULL)
        {
            if(index == 0)
            {
                this->pFirstNode = thisNode->pNextNode;
                this->size--;
            }
            else
            {
...
{
    int returnAux = -1;
    int cantidadEnLista = ll_len(this);

    if(this != NULL && cantidadEnLista > 0)
    {
        for(int i = cantidadEnLista -1; i >= 0; i--)
        {
            ll_remove(this, i);
        }
        returnAux = 0;
...
int ll_contains(LinkedList* this, void* pElement)
{
    ...
    if(this != NULL)
    {
        indiceElement = ll_indexOf(this, pElement);
        if(indiceElement > -1)
        {
            returnAux = 1;
        }
